...
class SharedPlot(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)  # Timestamp of sharing
...
class DataShare(db.Model):
    ...
    shared_at = db.Column(db.DateTime, default=datetime.utcnow)  # Timestamp of sharing
